...
USER root
RUN chown -R $USERNAME:$USERNAME $STEAMAPPDIR/SquadGame/ServerConfig/
RUN chown -R $USERNAME:$USERNAME $STEAMAPPDIR/SquadGame/Saved/Logs/
RUN chown -R $USERNAME:$USERNAME $STEAMAPPDIR/SquadGame/Saved/Crashes/
USER $USERNAME
